...
Now robust to missing files and social sentiment blend.
Outputs:
...
def update() -> Dict[str, Any]:
    ...
    # Load macro + news (latest available)
    ...
    # --- Optional social sentiment merge ---
    ...
    try:
        ...
        log(f"[context_state] ⚠️ Failed to write global state: {e}")
